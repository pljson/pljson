...
begin
  ...
  pljson_ut.testcase('Test equals(pljson_number, number)');
  begin
    pljson_ut.assertTrue(pljson_helper.equals(pljson_number(2), 2), 'pljson_helper.equals(pljson_number(2), 2)');
  end;
  
  -- equals(pljson_number, binary_double)
  pljson_ut.testcase('Test equals(pljson_number, binary_double)');
  /* E.I.Sarmas (github.com/dsnz)   2016-12-01   support for binary_double numbers */
  begin
    pljson_ut.assertTrue(pljson_helper.equals(pljson_number(2.718281828459e210d), 2.718281828459e210d), 'pljson_helper.equals(pljson_number(2.718281828459e210d), 2.718281828459e210d)');
  end;
  
  -- equals(pljson_string, varchar2)
  pljson_ut.testcase('Test equals(pljson_string, varchar2)');
  begin
    pljson_ut.assertTrue(pljson_helper.equals(pljson_string('xyz'), 'xyz'), 'pljson_helper.equals(pljson_string(''xyz''), ''xyz'')');
  end;
  
  -- equals(pljson_string, varchar2) - empty string value
  pljson_ut.testcase('Test equals(pljson_string, varchar2) - empty string value');
  begin
    pljson_ut.assertTrue(pljson_helper.equals(pljson_string(''), ''), 'pljson_helper.equals(pljson_string(''''), '''')');
  end;
  
  -- equals(pljson_bool, boolean)
  pljson_ut.testcase('Test equals(pljson_bool, boolean)');
  begin
    pljson_ut.assertTrue(pljson_helper.equals(pljson_bool(true), true), 'pljson_helper.equals(pljson_bool(true), true)');
    pljson_ut.assertTrue(pljson_helper.equals(pljson_bool(false), false), 'pljson_helper.equals(pljson_bool(false), false)');
  end;
  
  -- equals(pljson_string, clob)
  pljson_ut.testcase('Test equals(pljson_string, clob)');
  declare
    lob clob := 'long string value';
  begin
    pljson_ut.assertTrue(pljson_helper.equals(pljson_string(lob), lob), 'pljson_helper.equals(pljson_string(lob), lob)');
    pljson_ut.assertTrue(pljson_helper.equals(pljson_string('long string value'), lob), 'pljson_helper.equals(pljson_string(''long string value''), lob)');
    pljson_ut.assertFalse(pljson_helper.equals(pljson_string('not long string value'), lob), 'pljson_helper.equals(pljson_string(''not long string value''), lob)');
  end;
  ...
  pljson_ut.testcase('Test contains(pljson_list, pljson_number)');
  begin
    pljson_ut.assertTrue(pljson_helper.contains(pljson_list('[1,2,3,"xyz",[4,5],{"a":6}]'), pljson_number(3)), 'pljson_helper.contains(pljson_list(''[1,2,3,"xyz",[4,5],{"a":6}]''), pljson_number(3))');
  end;
