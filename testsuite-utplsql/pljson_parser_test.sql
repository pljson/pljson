create or replace package pljson_parser_test is
  ...
  --%test(Test no digits in fraction)
  procedure test_digit_fraction;
  
  --%test(Test no digits in exp)
...
end pljson_parser_test;
/

create or replace package body pljson_parser_test is
