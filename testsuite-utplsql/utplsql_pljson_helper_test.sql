...
create or replace package utplsql_pljson_helper_test is
  ...
  --%test(Test equals(pljson_string, pljson_string))
  procedure test_equals_string_string;
  ...
  --%test(Test equals(pljson_number, binary_double))
  procedure test_equals_number_double;
  
  --%test(Test equals(pljson_string, varchar2))
  ...
  --%test(Test equals(pljson_string, clob))
  procedure test_equals_string_clob;
...
create or replace package body utplsql_pljson_helper_test is
  ...
  procedure test_equals_number_number is
  begin
    assertTrue(pljson_helper.equals(pljson_number(2), 2), 'pljson_helper.equals(pljson_number(2), 2)');
  end;
  
  -- equals(pljson_number, binary_double)
  /* E.I.Sarmas (github.com/dsnz)   2016-12-01   support for binary_double numbers */
  procedure test_equals_number_double is
  begin
    assertTrue(pljson_helper.equals(pljson_number(2.718281828459e210d), 2.718281828459e210d), 'pljson_helper.equals(pljson_number(2.718281828459e210d), 2.718281828459e210d)');
  end;
  
  -- equals(pljson_string, varchar2)
  procedure test_equals_string_varchar2 is
  begin
    assertTrue(pljson_helper.equals(pljson_string('xyz'), 'xyz'), 'pljson_helper.equals(pljson_string(''xyz''), ''xyz'')');
  end;
  ...
  procedure test_equals_bool_boolean is
  begin
    assertTrue(pljson_helper.equals(pljson_bool(true),true), 'pljson_helper.equals(pljson_bool(true), true)');
    assertTrue(pljson_helper.equals(pljson_bool(false),false), 'pljson_helper.equals(pljson_bool(false), false)');
  end;
  
  -- equals(pljson_string, clob)
  procedure test_equals_string_clob is
    lob clob := 'long string value';
  begin
    assertTrue(pljson_helper.equals(pljson_string(lob), lob), 'pljson_helper.equals(pljson_string(lob), lob)');
    assertTrue(pljson_helper.equals(pljson_string('long string value'), lob), 'pljson_helper.equals(pljson_string(''long string value''), lob)');
    assertFalse(pljson_helper.equals(pljson_string('not long string value'), lob), 'pljson_helper.equals(pljson_string(''not long string value''), lob)');
  end;
