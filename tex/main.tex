...
\title{PL/JSON Reference Guide (version 0.8.3)}
...
45
\end{verbatim}
Square brackets cannot be used to extract JSON members like you would do in JavaScript (We will might add that feature later on). \\\\
